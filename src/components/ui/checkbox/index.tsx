export const CheckBox = (props: {
    ...
    return (
        <input
            id={id}
            type="checkbox"
            className={`defaultCheckBox relative inline-flex h-[20px] min-h-[20px] w-[20px] min-w-[20px] appearance-none items-center justify-center rounded-md border border-gray-300 text-white/0 outline-none transition ease-linear checked:border-none checked:text-white hover:cursor-pointer dark:border-white/10 ${
                color === 'red'
                    ? 'checked:border-none checked:bg-red-500 dark:checked:bd-red-400'
                    : color === 'blue'
                                                            ...
                                                            : color === 'amber'
                                                                ...
                                                                : color === 'gray'
                                                                    ...
                                                                    : color === 'indigo'
                                                                        ...
                                                                        : 'checked:bg-purple-400 dark:checked:bg-purple-400'
